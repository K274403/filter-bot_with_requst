...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6174868004 1798348973').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002081004430').split()').split()]
...
CHAT_ID = [int(app_chat_id) if id_pattern.search(app_chat_id) else app_chat_id for app_chat_id in environ.get('CHAT_ID', '-1002156162334').split()]
...
NO_RESULTS_CHANNEL = int(environ.get("NO_RESULTS_CHANNEL", "-1002186335716"))
...
S_GROUP = environ.get('S_GROUP',"http://t.me/rkmovieszip")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"")
FILE_FORWARD = environ.get('FILE_FORWARD',"")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺...')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', '-1002160766163'))
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002160766163')).split()]
